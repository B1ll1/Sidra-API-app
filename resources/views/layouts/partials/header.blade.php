<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-mini"><b>SIDR</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SIDRA</b></span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        ...
        {{--
          ...
          {{-- @if(isset(Auth::user()->republic_id))
          <!-- Notifications: style can be found in dropdown.less -->
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-bell-o"></i>
               @if(Auth::user()->republic->getNumberOfRequests() !== 0)
              <span class="label label-warning">{{Auth::user()->republic->getNumberOfRequests()}}</span>
              @endif
            </a>
            @if(Auth::user()->republic->getNumberOfRequests() !== 0)
            <ul class="dropdown-menu">
              <li>
                  <li>
                    <a href="{{route('request.index')}}">
                      <i class="fa fa-users text-aqua"></i> Vocês tem {{Auth::user()->republic->getNumberOfRequests()}} canditados a vaga.
                    </a>
                  </li>
              </li>
            </ul>
            ...
            <ul class="dropdown-menu">
              <li>
                  <li>
                    <a href="{{route('request.index')}}">
                      <i class="fa fa-users text-aqua"></i> Vocês tem 0 canditados a vaga.
                    </a>
                  </li>
              </li>
            </ul>
